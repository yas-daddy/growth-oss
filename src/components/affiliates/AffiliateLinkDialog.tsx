...
import { downloadCsv, generateCsv, type MetricRow } from '@/lib/exportCsv';
...
export function AffiliateLinkDialog({ 
  ...
  const handleDownloadCsv = () => {
    const headers = ['Campaign Name', 'URL'];
    const rows: MetricRow[] = generatedLinks.map(link => ({
      label: link.campaign_name,
      values: [link.url],
    }));
    
    // Build CSV manually for this format
    const csvContent = [
      'Campaign Name,URL',
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Create tracking links for campaigns. Media source{' '}
        ...
        <div className="space-y-4 pt-2">
          <div className="space-y-2">
            <Label htmlFor="campaigns">Campaign Names</Label>
            <Textarea
              id="campaigns"
