...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      daily_revenue_metrics: {
        Row: {
          ...
          ftd_cohort_net_deposits: number | null
          ftd_cohort_withdrawals: number | null
      ...
      email_campaign_schedules: {
        ...
        Relationships: [
          {
            foreignKeyName: "email_campaign_schedules_campaign_id_fkey"
            columns: ["campaign_id"]
            isOneToOne: false
            referencedRelation: "email_campaign_settings"
            referencedColumns: ["id"]
          },
        ]
      }
      email_campaign_settings: {
        Row: {
          ...
          created_at: string
          custom_content_blocks: Json | null
          custom_mock_attributes: Json | null
      ...
      football_fixtures: {
        ...
        Relationships: [
          {
            foreignKeyName: "football_fixtures_away_team_id_fkey"
          ...
          {
            foreignKeyName: "football_fixtures_home_team_id_fkey"
      ...
      football_team_scores: {
        ...
        Relationships: [
          {
            foreignKeyName: "football_team_scores_team_id_fkey"
            columns: ["team_id"]
            isOneToOne: true
            referencedRelation: "football_teams"
            referencedColumns: ["id"]
      ...
      generated_football_ads: {
        ...
        Relationships: [
          {
            foreignKeyName: "generated_football_ads_fixture_id_fkey"
            columns: ["fixture_id"]
            isOneToOne: false
            referencedRelation: "football_fixtures"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "generated_football_ads_template_id_fkey"
            columns: ["template_id"]
            isOneToOne: false
      ...
      push_notification_schedules: {
        ...
        Relationships: [
          {
            foreignKeyName: "push_notification_schedules_fixture_id_fkey"
            columns: ["fixture_id"]
            isOneToOne: false
            referencedRelation: "football_fixtures"
            referencedColumns: ["id"]
    ...
    Functions: {
      get_daily_channel_cpa: {
        Args: { p_channel: string; p_end_date: string; p_start_date: string }
        Returns: {
          cpa: number
          date: string
        }[]
      }
      get_ftd_cohort_deposits: {
        Args: { end_date: string; start_date: string }
        Returns: {
          avg_per_ftd_user: number
          ftd_user_count: number
          total_deposits: number
        }[]
      }
      get_ftd_cohort_net_deposits: {
        Args: { end_date: string; start_date: string }
        Returns: {
          avg_net_per_ftd_user: number
          ftd_user_count: number
          net_deposits: number
          total_deposits: number
      ...
      get_report_affiliate_performance: {
        Args: { end_date: string; start_date: string }
        Returns: {
          affiliate_id: string
      ...
      get_report_avg_deposit_per_ftd: {
        Args: { end_date: string; start_date: string }
        Returns: {
          previous_value: number
          value: number
      ...
      get_report_channel_performance: {
        Args: { end_date: string; start_date: string }
        Returns: {
          channel: string
          channel_type: string
      ...
      populate_user_ftd_dates: { Args: never; Returns: number }
    }
    Enums: {
